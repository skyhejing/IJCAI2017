function [f,g] = list_update_u_l_two(u_l_sample, l_u,trainset_three,lamda,h,matrix_feature)
%deal f
...
u_l_new_cell=arrayfun(@(i) list_update_u_l_two_gradient( l_u,u_l_sample,trainset_three,matrix_feature,lamda,i ),1:size(u_l_sample,1),'UniformOutput', false);
